...
export default async function ClubPage({
  ...
  const sortKey = normSortKey(searchParams?.sort);
  const dir = searchParams?.dir ? normDir(searchParams?.dir) : defaultDirForKey(sortKey);
  ...
  return (
    <main
      ...
      style={{ ['--c1' as any]: c1, ['--c2' as any]: c2, ['--c3' as any]: c3 }}
    >
      <div className={styles.header}>
